...
class Main_System   // this is the main class that combine all the classes.. only one object should be created
{
    public:
        ...
        void reserve(unsigned char ,unsigned char); // function to reserve seat when entering any classroom
        void avail (unsigned char ,unsigned char); // function to avail seat when leaving the classroom
        bool set_card(Card*);
    ...
    private:
        ...
        Card* L_C[256]={nullptr};// list of cards
};
